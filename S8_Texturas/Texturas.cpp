/*!
	...
	Programa ejemplo de aplicacion de texturas
...
// Inicializaciones
{
	...
	const GLfloat L0D[]{ 0.3,0.3,0.3,1 };
	glLightfv(GL_LIGHT0, GL_DIFFUSE, L0D);

	glLightfv(GL_LIGHT1, GL_DIFFUSE, GRISOSCURO);
	glLightfv(GL_LIGHT1, GL_SPECULAR, GRISOSCURO);
	glLightf(GL_LIGHT1, GL_SHININESS, 40);
...
// Funcion de atencion al dibujo
{
	...
	glBegin(GL_POLYGON);
	glNormal3f(0, 0, 1);		// Todos tienen la misma normal
